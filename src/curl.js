...
module.exports = {
  createCurlString: function(yate, config) {
    var ajaxConfig = sparql.getAjaxConfig(yate, config);
    ...
    var cmds = ["curl", url, "-X", yate.options.sparql.requestMethod];
    if (yate.options.sparql.requestMethod == "POST") {
